          ...
          <div className="space-y-2">
            {quickLinks.map((item) => {
              ...
              return (
                <Link
                  key={item.path}
                  className="flex items-center gap-3 rounded-lg px-2 py-2.5 transition hover:bg-surface-container-low"
                  to={item.path}
                >
          ...
          <div className="divide-y divide-outline-variant">
            {visibleActivities.length === 0 ? (
              <p className="py-4 text-sm text-on-surface-variant">
                Chưa có hoạt động đang diễn ra hoặc sắp diễn ra.
              </p>
            ) : (
        ...
        <Card>
          <div className="mb-5 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-on-surface-variant">
                {formatNumber(urgentNotifications.length)} thông báo cấp bách
              </p>
            </div>
            <Link
              className="text-sm font-semibold text-primary"
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm text-on-surface-variant">
                        {formatDateTime(
                          notification.createdAt || notification.startDate,
                        )}
                      </p>
                    </div>
